...
export function Disclaimer() {
  return (
    <div className="flex items-start gap-2 px-3 py-2 bg-yellow-500/5 border border-yellow-500/20 rounded-lg text-micro text-yellow-400/80 leading-relaxed" data-testid="disclaimer">
